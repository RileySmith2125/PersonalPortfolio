// Compact "2025" / "2024—25" meta-line date format shared by the project
// detail page and the full-portfolio print document. Ongoing projects (no
// endDate) show the start year alone, with no trailing dash.
